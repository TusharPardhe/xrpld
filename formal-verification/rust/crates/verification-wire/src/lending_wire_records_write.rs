use super::super::{lending_wire_primitive as p, lending_wire_types::*};
...
pub(crate) fn vault(o: &mut Vec<u8>, x: Vault) -> Result<(), p::WireError> {
...
pub(crate) fn broker(o: &mut Vec<u8>, x: LoanBroker) -> Result<(), p::WireError> {
...
fn fees(o: &mut Vec<u8>, x: LoanFees) -> Result<(), p::WireError> {
...
pub(crate) fn loan(o: &mut Vec<u8>, x: Loan) -> Result<(), p::WireError> {
...
pub(crate) fn state(o: &mut Vec<u8>, x: LendingState) -> Result<(), p::WireError> {
    vault_identity(o, x.vault_identity);
    vault(o, x.vault)?;
    broker(o, x.broker)?;
    loan(o, x.loan)
}
pub(crate) fn broker_vault(o: &mut Vec<u8>, x: BrokerVault) -> Result<(), p::WireError> {
    vault_identity(o, x.vault_identity);
    vault(o, x.vault)?;
    broker(o, x.broker)
}
pub(crate) fn loan_vault(o: &mut Vec<u8>, x: LoanVault) -> Result<(), p::WireError> {
    vault_identity(o, x.vault_identity);
    loan(o, x.loan)?;
    vault(o, x.vault)
}
